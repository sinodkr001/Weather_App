...
export default function Temprature({setCity, stats}) {
    ...
    return (
        <>
           <div className='flex justify-between'>
               <input 
               type='text' 
               className='bg-slate-500 text-slate-200 placeholder-slate-400 text-md w-60 p-2 focus:outline-none focus:border-slate-400' 
